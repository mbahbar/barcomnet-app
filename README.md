...
![ISP Management Hero](public/img/barcom.png)
...
[![GitHub license](https://img.shields.io/github/license/mbahbar/barcomnet-app)](https://github.com/mbahbar/barcomnet-app/blob/main/LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/mbahbar/barcomnet-app)](https://github.com/mbahbar/barcomnet-app/stargazers)
[![Version](https://img.shields.io/badge/version-R%201.0.1%20B1-blue)](#)
[![OS Support](https://img.shields.io/badge/OS-Linux%20%28Debian%2FUbuntu%2FArmbian%29-orange)](#)
...
- **Versi**: `R 1.0.1 B1`
- **Sistem Operasi**: Linux (Debian / Ubuntu / Armbian)
...
```bash
git clone https://github.com/mbahbar/barcomnet-app.git
cd barcomnet-app
...
Managed by [Barcomnet App](https://github.com/mbahbar/barcomnet-app)

## Info & donasi

085339275803 — https://wa.me/barcomnet
